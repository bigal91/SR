...
/**
 * EditProvisionedServiceRequestResource.java
 *
 ...
 */
            ...
            /**
            *  EditProvisionedServiceRequestResource bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class EditProvisionedServiceRequestResource
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://serviceregistry.ba.stutt.de/ServiceRegistry",
                "editProvisionedServiceRequestResource",
                "ns1");
                        ...
                        */
                        ...
                        /**
                        * field for NewEndpoint
                        */

                        
                                    protected java.lang.String localNewEndpoint ;
                           ...
                           * @return java.lang.String
                           */
                           public  java.lang.String getNewEndpoint(){
                               return localNewEndpoint;
                           }
                            ...
                            /**
                               * Auto generated setter method
                               * @param param NewEndpoint
                               */
                               public void setNewEndpoint(java.lang.String param){
                            
                                            this.localNewEndpoint=param;
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":editProvisionedServiceRequestResource",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "editProvisionedServiceRequestResource",
                           xmlWriter);
                                   ...
                                   xmlWriter.writeEndElement();
                                    ...
                                    namespace = "";
                                    writeStartElement(null, namespace, "newEndpoint", xmlWriter);
                             

                                          if (localNewEndpoint==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("newEndpoint cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localNewEndpoint);
                            ...
                            elementList.add(new javax.xml.namespace.QName("",
                                    ...
                                    elementList.add(localNewProtocolType);
                                      ...
                                      elementList.add(new javax.xml.namespace.QName("",
                                        ...
                                        if (localNewEndpoint != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localNewEndpoint));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("newEndpoint cannot be null!!");
                                        }
    ...
    public static class Factory{
        ...
        */
        public static EditProvisionedServiceRequestResource parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            EditProvisionedServiceRequestResource object =
                new EditProvisionedServiceRequestResource();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"editProvisionedServiceRequestResource".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (EditProvisionedServiceRequestResource)de.stutt.ba.serviceregistry.serviceregistry.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("","newEndpoint").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"newEndpoint" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setNewEndpoint(
                                                    org.apache.axis2.databinding.utils.ConverterUtil.convertToString(content));
