 ...
 */
            ...
            /**
            *  LoginUserRequestResource bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class LoginUserRequestResource
        implements org.apache.axis2.databinding.ADBBean{
        
                public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
                "http://serviceregistry.ba.stutt.de/ServiceRegistry",
                "loginUserRequestResource",
                "ns1");
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":loginUserRequestResource",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "loginUserRequestResource",
    ...
    public static class Factory{
        ...
        */
        public static LoginUserRequestResource parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            LoginUserRequestResource object =
                new LoginUserRequestResource();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"loginUserRequestResource".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (LoginUserRequestResource)de.stutt.ba.serviceregistry.serviceregistry.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
