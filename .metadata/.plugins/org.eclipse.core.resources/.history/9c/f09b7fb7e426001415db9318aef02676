...
/**
 * CreateServiceConfigurationRequestResource.java
 *
 ...
 */
            ...
            /**
            *  CreateServiceConfigurationRequestResource bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CreateServiceConfigurationRequestResource
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":createServiceConfigurationRequestResource",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "createServiceConfigurationRequestResource",
    ...
    public static class Factory{
        ...
        */
        public static CreateServiceConfigurationRequestResource parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            CreateServiceConfigurationRequestResource object =
                new CreateServiceConfigurationRequestResource();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"createServiceConfigurationRequestResource".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (CreateServiceConfigurationRequestResource)de.stutt.ba.serviceregistry.serviceregistry.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
