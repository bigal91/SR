...
/**
 * RegisterUserRequestResource.java
 *
 ...
 */
            ...
            /**
            *  RegisterUserRequestResource bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class RegisterUserRequestResource
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":registerUserRequestResource",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "registerUserRequestResource",
    ...
    public static class Factory{
        ...
        */
        public static RegisterUserRequestResource parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            RegisterUserRequestResource object =
                new RegisterUserRequestResource();
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"registerUserRequestResource".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (RegisterUserRequestResource)de.stutt.ba.serviceregistry.serviceregistry.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
