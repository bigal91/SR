...
public class EnvConfiguration {
	public static enum ConfigID {
		LOGIN_ENABLED, USER_NAME, USER_PASSWORD, USER_MAIL, URLBASE, HOST, TOKEN_LENGTH, TOKEN_MINUTE_DURATION
	}
...
//			sr.close();
	...
	public static String getDefaultUserMail() {
		return (String) configuration.get(ConfigID.USER_MAIL);
	}
	
	public static String getTokenLength() {
		return (String) configuration.get(ConfigID.TOKEN_LENGTH);
	}
	
	public static String getTokenMinuteDuration(){
		return (String) configuration.get(ConfigID.TOKEN_MINUTE_DURATION);
	}
}
